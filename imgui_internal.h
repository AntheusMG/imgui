...
//#endif
    ...
    IMGUI_API bool          DragBehavior(ImGuiID id, ImGuiDataType data_type, void* p_v1, void* p_v2, float v_speed, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags);
